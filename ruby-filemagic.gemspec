...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/filemagic/ext.rb", "lib/filemagic/version.rb", "lib/filemagic.rb", "ext/filemagic.c", "test/pyfile", "test/mahoro.c", "test/pylink", "test/pyfile-compressed.gz", "test/perl", "test/leaktest.rb", "test/filemagic_test.rb", "test/excel-example.xls", "README", "CHANGELOG", "Rakefile", "TODO", "info/filemagic.rd", "info/example.rb", "ext/extconf.rb"]
  s.homepage = %q{http://ruby-filemagic.rubyforge.org/}
  s.rdoc_options = ["--title", "ruby-filemagic Application documentation", "--main", "README", "--line-numbers", "--inline-source", "--all", "--charset", "UTF-8"]
  s.require_paths = ["lib"]
